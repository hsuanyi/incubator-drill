...
public class GlobalFunctionRegistry {
  private FunctionImplementationRegistry functionImplementationRegistryException;
  private FunctionImplementationRegistry functionImplementationRegistryNullable;
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(GlobalFunctionRegistry.class);

  public static class FunctionImplementationRegistry implements FunctionLookupContext {
    ...
    private FunctionImplementationRegistry(DrillFunctionRegistry drillFuncRegistry, List<PluggableFunctionRegistry> pluggableFuncRegistries) {
  ...
  public GlobalFunctionRegistry(DrillConfig config) {
    functionImplementationRegistryException = new FunctionImplementationRegistry(config);
    functionImplementationRegistryNullable = functionImplementationRegistryException.createFunctionRegistryWithNullableHolders();
  }

  public GlobalFunctionRegistry(DrillConfig config, ScanResult classpathScan, SystemOptionManager systemOptions) {
    functionImplementationRegistryException = new FunctionImplementationRegistry(config, classpathScan, systemOptions);
    functionImplementationRegistryNullable = functionImplementationRegistryException.createFunctionRegistryWithNullableHolders();
  }

  public FunctionImplementationRegistry getFunctionImplementationRegistryAsException() {
    return functionImplementationRegistryException;
  }

  public FunctionImplementationRegistry getFunctionImplementationRegistryAsNull() {
    return functionImplementationRegistryNullable;
  }
}