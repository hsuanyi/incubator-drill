...
public abstract class FilterTemplate4 implements Filterer {
  ...
  @Override
  public void setup(FragmentContext context, RecordBatch incoming, RecordBatch outgoing, TransferPair[] transfers, AbstractSkipRecordLogging skipRecordLogging)
