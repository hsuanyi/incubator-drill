...
public class TypeInferenceUtils {
  ...
  /**
   * Based on whether decimal type is supported or not, this method creates an ExplicitOperatorBinding which interprets
  ...
  private static boolean isDecimalLiteral(final SqlOperatorBinding sqlOperatorBinding, final int index) {
    return sqlOperatorBinding.getOperandType(index).getSqlTypeName() == SqlTypeName.DECIMAL
        && sqlOperatorBinding.isOperandLiteral(index);
  }
