...
public class TestWindowFunctions extends BaseTestQuery {
  ...
  public void testSinglePartition() throws Exception {
    ...
    testBuilder()
        ...
        .baselineValues(2l, 25l)
        .baselineValues(3l, 25l)
        .baselineValues(4l, 25l)
        .baselineValues(5l, 25l)
        .baselineValues(6l, 25l)
        .baselineValues(7l, 25l)
        .baselineValues(8l, 25l)
        .baselineValues(9l, 25l)
        .baselineValues(10l, 25l)
        .baselineValues(11l, 25l)
        .baselineValues(12l, 25l)
        .baselineValues(13l, 25l)
        .baselineValues(14l, 25l)
        .baselineValues(15l, 25l)
        .baselineValues(16l, 25l)
        .baselineValues(17l, 25l)
        .baselineValues(18l, 25l)
        .baselineValues(19l, 25l)
        .baselineValues(20l, 25l)
        .baselineValues(21l, 25l)
        .baselineValues(22l, 25l)
        .baselineValues(23l, 25l)
        .baselineValues(24l, 25l)
        .build()
        .run();
  }
