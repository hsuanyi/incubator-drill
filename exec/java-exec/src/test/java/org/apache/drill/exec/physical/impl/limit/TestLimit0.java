...
public class TestLimit0 extends BaseTestQuery {
  ...
  private static void checkThatQueryPlanIsNotOptimized(final String query) throws Exception {
    PlanTestBase.testPlanMatchingPatterns(
        wrapLimit0(query),
        new String[]{},
        new String[]{
  ...
  public void rank() throws Exception {
    ...
    @SuppressWarnings("unchecked")
    final List<Pair<SchemaPath, TypeProtos.MajorType>> expectedSchema = Lists.newArrayList(
        Pair.of(SchemaPath.getSimplePath("r"), Types.optional(TypeProtos.MinorType.BIGINT)));
